...
find "$TEMP_DIR" -type f -exec sed -i "s/jupiter/$PROJECT_NAME/g" {} \;
find "$TEMP_DIR" -type f -exec sed -i "s/app-server/app-server/g" {} \;
find "$TEMP_DIR" -type f -exec sed -i "s/worker-sample/worker-sample/g" {} \;
find "$TEMP_DIR" -type f -exec sed -i "s/web-app/web-app/g" {} \;
