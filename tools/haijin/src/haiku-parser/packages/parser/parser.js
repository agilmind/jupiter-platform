...
exports.getPythonPath = exports.runPegParser = void 0;
var dotenv_1 = require("dotenv");
var python_shell_1 = require("python-shell");
var runPegParser = function (_a) {
    var parserPath = _a.parserPath, content = _a.content, _b = _a.pythonPath, pythonPath = _b === void 0 ? (0, exports.getPythonPath)() : _b;
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_c) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    var pyshell = new python_shell_1.PythonShell(parserPath, {
...
exports.runPegParser = runPegParser;
var getPythonPath = function () {
